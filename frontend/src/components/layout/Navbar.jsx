...
const Navbar = () => {
  ...
  return (
    ...
    >
      <nav>
        <div className="logo">
         <img src="https://visionhospitalgoa.com/wp-content/uploads/2020/09/175-1757329_my-blog-logo-png-transparent-png.png"  style={{height:55,width:55,borderRadius:25}}/>BUZZ
        </div>
